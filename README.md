...
| <a href="plugins/utopia-pubdev/"><img src="docs/tiles/utopia-pubdev.png" width="249" alt="Utopia Pub.dev"/></a> | Standardize pub.dev package READMEs for any Dart/Flutter repo - brand-profile-driven header and four-colour badge row, house voice, section structure, sibling footer, and a tool-agnostic AI-assistants section. Utopia branding auto-applies in Utopia codebases; other repos set up their own profile via the bundled `brand-setup` skill. |
...
- [Utopia Design Protocol - tokens & rebranding](plugins/utopia-design/skills/tokens/SKILL.md) (companion tooling ships as `utopia_design_tools`; a git dependency until it reaches pub.dev - see the skill's validation reference)
