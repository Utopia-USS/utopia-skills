...
See `composable-hooks.md` → "Per-item state: three archetypes" in the installed `utopia-hooks` plugin (resolve it per SKILL.md "Resolving reference paths") for the decision tree:
